...
<section class="bg-altlight m-5 p-5">
    ...
    <div class="col-6 my-5 mx-auto">    <!-- plus: col-md-2-->
        <p class="">Email address:
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad aliquam consequuntur deserunt ducimus, eveniet nostrum perferendis quas quos reiciendis temporibus.
        </p>
