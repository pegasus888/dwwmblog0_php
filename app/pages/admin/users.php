...
<div class="col-md-6 mx-auto">
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="my-2">
            <label class="d-block">
                <img class="mx-auto d-block image-preview-edit" src="<?=ROOT?>../../public/assets/images/no_image.jpg" style="cursor: pointer;width: 150px;height: 150px;object-fit: cover;">
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td></td>
            <td>
                <img src="<?=ROOT?>../../public/assets/images/no_image.jpg" style="width: 100px;height: 100px;object-fit: cover;">
            </td>
            <td></td>
            <td>
                <a href="<?=ROOT?>/admin/users/edit">
                ...
                <a href="<?=ROOT?>/admin/users/delete">
